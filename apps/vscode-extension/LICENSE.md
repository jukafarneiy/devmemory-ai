...
- Install and run the software locally for development, evaluation, and testing.
- Inspect the source code to understand behavior and report issues.
- Make local modifications strictly for the purpose of debugging or contributing back to the project.

## You may not, without prior written permission

- Redistribute the software, in source or binary form, to third parties.
- Sublicense, sell, rent, or offer the software as a hosted service.
